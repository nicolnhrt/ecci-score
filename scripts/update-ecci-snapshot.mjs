...
const HISTORY_BASE_PATH = path.resolve("frontend/data/ecci-history-base.json");
const RECENT_PATH = path.resolve("frontend/data/ecci-recent.json");
const SNAPSHOT_PATH = path.resolve("frontend/data/ecci-snapshot.json");
